...
public class Client {
    /**
     * Most of this is for the input in command line, parsing file names, ports etc. should be pretty easy reading
     *
     * @param args
     * @throws IOException
     */
    public static void main(String[] args) throws IOException {
        /**
         * Argument check for client folder section
         */
        if (args.length < 2) {
        ...
        String address = InetAddress.getByName("eecslab-10.case.edu").getHostAddress();//Neighbhor connection is defined here to connect to the "server" (peer)
        int port = 51740;
        try {
        ...
        try {
            ...
            System.out.println("There isn't any instance of server running. Start one first!");//Don't break my code, please start the server first. All you have to do is type run_client.
            return;
        }
