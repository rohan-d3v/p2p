...
help(){
    if [ $# -eq 0 ]; then
        ...
        echo "        bench_registry_nodes - Run a Benchmarking registering multiple peers with a multiple registry of the peer"
        ...
        echo "        "
            ...
            echo "        - numPeers: number of Peers registering"
            echo "        - folderName: the benchmarking is a peer so needs a folder name to register to the Server"
            echo "        - numRegistryPerNode - how many times will register each peer"
            echo "        "
            echo "        or"
            echo "        "
